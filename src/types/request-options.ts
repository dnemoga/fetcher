...
export interface RequestOptions extends FetcherOptions {
  ...
  /**
   * An {@link https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal | `AbortSignal`} object instance; allows you to communicate with a fetch request and abort it if required via an {@link https://developer.mozilla.org/en-US/docs/Web/API/AbortController | `AbortController`}.
   */
